...
CREATE TABLE `teach_course_info` (
  ...
  `school_name` varchar(30) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`),
  KEY `idx_school_grade_class_teacher` (`school_name`,`grade_name`,`class_name`,`teacher_id`)
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb3;

/*Data for the table `teach_course_info` */

insert  into `teach_course_info`(`id`,`teacher_id`,`teacher_name`,`classroom_real_id`,`grade_name`,`class_name`,`course_name`,`school_name`) values (1,1,'褚悦真','101','一年级','一班','数学','青青草原第一小学'),(2,2,'汤妍翔','101','一年级','一班','英语','青青草原第一小学'),(3,3,'阮舒琛','101','一年级','一班','语文','青青草原第一小学'),(4,4,'秦致','101','一年级','一班','品德','青青草原第一小学'),(5,5,'韦莲','101','一年级','一班','科学','青青草原第一小学'),(6,6,'顾姣英','101','一年级','一班','数学','青青草原第一小学'),(7,7,'郭卿启','101','一年级','一班','英语','青青草原第一小学'),(8,8,'江云','101','一年级','一班','语文','青青草原第一小学'),(9,9,'邬瑞','101','一年级','一班','品德','青青草原第一小学'),(10,10,'韦仪凡','101','一年级','一班','科学','青青草原第一小学'),(11,6,'顾姣英','102','一年级','二班','数学','青青草原第一小学'),(12,7,'郭卿启','102','一年级','二班','英语','青青草原第一小学'),(13,8,'江云','102','一年级','二班','语文','青青草原第一小学'),(14,9,'邬瑞','102','一年级','二班','品德','青青草原第一小学'),(15,10,'韦仪凡','102','一年级','二班','科学','青青草原第一小学'),(16,1,'褚悦真','203','二年级','三班','数学','青青草原第一小学'),(17,2,'汤妍翔','203','二年级','三班','英语','青青草原第一小学'),(18,3,'阮舒琛','203','二年级','三班','语文','青青草原第一小学'),(19,4,'秦致','203','二年级','三班','品德','青青草原第一小学'),(20,5,'韦莲','203','二年级','三班','科学','青青草原第一小学'),(25,11,'卞雄辰','203','二年级','三班','数学','熊森林第一小学'),(26,12,'韦瑶蕊','203','二年级','三班','英语','熊森林第一小学'),(27,13,'周雪','203','二年级','三班','语文','熊森林第一小学');
...
CREATE TABLE `teacher` (
  `id` int NOT NULL AUTO_INCREMENT,
  `real_id` varchar(7) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `name` varchar(20) NOT NULL DEFAULT '',
...
insert  into `teacher`(`id`,`real_id`,`name`,`teach_course_name`,`school_name`) values (1,'2020001','褚悦真','数学','青青草原第一小学'),(2,'2020002','汤妍翔','英语','青青草原第一小学'),(3,'2020003','阮舒琛','语文','青青草原第一小学'),(4,'2020004','秦致','品德','青青草原第一小学'),(5,'2020005','韦莲','科学','青青草原第一小学'),(6,'2020006','顾姣英','数学','青青草原第一小学'),(7,'2020007','郭卿启','英语','青青草原第一小学'),(8,'2020008','江云','语文','青青草原第一小学'),(9,'2020009','邬瑞','品德','青青草原第一小学'),(10,'2020010','韦仪凡','科学','青青草原第一小学'),(11,'2021010','卞雄辰','数学','熊森林第一小学'),(12,'2021011','韦瑶蕊','英语','熊森林第一小学'),(13,'2021012','周雪','语文','熊森林第一小学');
